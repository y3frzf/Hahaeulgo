...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(22, 12, 20),
        MainColor = Color3.fromRGB(34, 18, 32),
        AccentColor = Color3.fromRGB(255, 105, 180),
        OutlineColor = Color3.fromRGB(80, 40, 70),
        FontColor = Color3.fromRGB(255, 220, 235),
...
do
    ...
    function Funcs:AddLabel(...)
        ...
        local TextLabel = New("TextLabel", {
            ...
            Text = Label.Text,
            TextSize = math.max(15, Data.Size),
    ...
    function Funcs:AddButton(...)
        ...
        local function CreateButton(Button)
            ...
            New("UIScale", { Scale = 1, Parent = Base })
        ...
        local function InitEvents(Button)
            table.insert(Button.Connections, Button.Base.MouseEnter:Connect(function()
                ...
                Button.Tween = TweenService:Create(Button.Base, Library.TweenInfo, {
                    TextTransparency = 0,
                    BackgroundColor3 = Library.Scheme.MainColor:Lerp(Library.Scheme.AccentColor, 0.15),
                })
                Button.Tween:Play()
            end))
            ...
            table.insert(Button.Connections, Button.Base.MouseButton1Down:Connect(function()
                ...
                local Scale = Button.Base:FindFirstChildOfClass("UIScale")
                if Scale then TweenService:Create(Scale, Library.TweenInfo, { Scale = 0.98 }):Play() end
            end))
            table.insert(Button.Connections, Button.Base.MouseButton1Up:Connect(function()
                local Scale = Button.Base:FindFirstChildOfClass("UIScale")
                if Scale then TweenService:Create(Scale, Library.TweenInfo, { Scale = 1 }):Play() end
            end))
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        function Toggle:Display()
            ...
            Ball.BackgroundColor3 = Library.Scheme.WhiteColor
            Library.Registry[Ball].BackgroundColor3 = "WhiteColor"
            BallStroke.Color = Library.Scheme.OutlineColor
            Library.Registry[BallStroke].Color = "OutlineColor"
        end
    ...
    function Funcs:AddInput(Idx, Info)
        ...
        local InputUnderline = New("Frame", {
            AnchorPoint = Vector2.new(0, 1),
            BackgroundColor3 = "AccentColor",
            BackgroundTransparency = 1,
        ...
        table.insert(Input.Connections, Box.Focused:Connect(function()
            TweenService:Create(InputUnderline, Library.TweenInfo, { BackgroundTransparency = 0 }):Play()
            TweenService:Create(BoxStroke, Library.TweenInfo, { Color = Library.Scheme.AccentColor }):Play()
        end))
        table.insert(Input.Connections, Box.FocusLost:Connect(function()
            TweenService:Create(InputUnderline, Library.TweenInfo, { BackgroundTransparency = 1 }):Play()
            TweenService:Create(BoxStroke, Library.TweenInfo, { Color = Library.Scheme.OutlineColor }):Play()
        end))
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        table.insert(Slider.Connections, Bar.MouseEnter:Connect(function()
            ...
            TweenService:Create(Bar, Library.TweenInfo, {
                BackgroundColor3 = Library.Scheme.MainColor:Lerp(Library.Scheme.FontColor, 0.08),
            }):Play()
        end))
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local function CreatePoolRow()
            ...
            function Row:UpdateButton()
                ...
                Container.BackgroundTransparency = Selected and 0.7 or 1
...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        local WindowShadow = New("Frame", {
            BackgroundTransparency = 1,
            Position = UDim2.fromOffset(WindowInfo.Position.X.Offset - 4, WindowInfo.Position.Y.Offset - 4),
            Size = UDim2.new(WindowInfo.Size.X.Scale, WindowInfo.Size.X.Offset + 8, WindowInfo.Size.Y.Scale, WindowInfo.Size.Y.Offset + 8),
            Visible = false,
            ZIndex = 0,
            Parent = ScreenGui,
        })
        New("UICorner", { CornerRadius = UDim.new(0, 12), Parent = WindowShadow })
        New("UIStroke", { Color = Library.Scheme.DarkColor, Thickness = 8, Transparency = 0.72, Parent = WindowShadow })
        Library:GiveSignal(RunService.RenderStepped:Connect(function()
            if WindowShadow and MainFrame then
                WindowShadow.Position = UDim2.fromOffset(MainFrame.AbsolutePosition.X - 4, MainFrame.AbsolutePosition.Y - 4)
                WindowShadow.Size = UDim2.fromOffset(MainFrame.AbsoluteSize.X + 8, MainFrame.AbsoluteSize.Y + 8)
                WindowShadow.Visible = MainFrame.Visible
            end
        end))
        table.insert(
            Library.Corners,
        ...
        Tabs = New("ScrollingFrame", {
            ...
            Size = UDim2.new(0, InitialLeftWidth, 1, -78),
            Parent = MainFrame,
        })
        New("UIListLayout", {
        ...
        Container = New("Frame", {
            ...
            ClipsDescendants = true,
            Name = "Container",
            Position = UDim2.new(1, 0, 0, 57),
            Size = UDim2.new(1, -InitialLeftWidth - 1, 1, -78),
            Parent = MainFrame,
        })
        New("UIPadding", {
    ...
    local function ApplyCompact()
        ...
        for _, Button in Library.TabButtons do
            ...
            Button.Padding.PaddingLeft = UDim.new(0, IsCompact and 6 or 14)
            Button.Padding.PaddingRight = UDim.new(0, IsCompact and 6 or 14)
    ...
    function Window:SetSidebarWidth(Width)
        ...
        Tabs.Size = UDim2.new(0, Width, 1, -78)
        Container.Size = UDim2.new(1, -Width - 1, 1, -78)
